    ...
    <div className="section-container py-5 md:py-10" id="my-experience">
      ...
      <div className="mt-10 flex flex-col md:flex-row md:items-start md:py-32">
        <div className="px-12 md:px-32 flex flex-col gap-2 items-center">
          ...
          />
          <div className="flex gap-5 mt-10 md:mt-0 items-center">
            <motion.div
              initial={"offScreen"}
              whileInView={"onScreen"}
        ...
        <div className="flex flex-col gap-3 mt-10 md:mt-0 p-5 items-center">
          ...
          >
            ...
            <p className="font-para font-bold text-sm md:text-md text-center">
              In my 4 years experience I have got the privilege's to work with
              the University of Dodoma in a team based project to develop a
              Timetable Management System which is currently used within all 7
